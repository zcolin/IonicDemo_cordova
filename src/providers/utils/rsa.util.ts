...
export class RsaUtil {
    ...
    //公钥
    private static publicKey: string = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDlSfUJ3rvG6YpGOyQIfQe/FA+asDeHjhiMPohdvcDUNomMRuUuK5Jrl7FYoJZFN0QmiTs2ZLQoQW8+YG5xLkFUJyBFuA6FctL9F8Soy1FgcoHXPAHok4npUco4uyt3f29OURTb14urjF6wdJT8YmKSZcDMWul/jrUWh5zS96MZowIDAQAB";
     ...
     * @param text 公钥
     */
    public static encrpt(text: string): string {

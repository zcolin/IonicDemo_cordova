 ...
 */
@Injectable()
export class GaodeBaseLayer extends BaseLayer {
        ...
        return loadModules([
            ...
            let baseLayerVec = new Basemap({
                baseLayers: new WebTileLayer(
                    {
                        urlTemplate: "http://wprd0{subDomain}.is.autonavi.com/appmaptile?x={col}&y={row}&z={level}&lang=zh_cn&size=1&scl=1&style=7",
                        subDomains: ["1", "2", "3", "4"],
                    }
                ),
                spatialReference: spatialReference,
            ...
            let baseLayerImg = new Basemap({
                baseLayers: [
                    new WebTileLayer({
                        urlTemplate: "http://wprd0{subDomain}.is.autonavi.com/appmaptile?x={col}&y={row}&z={level}&lang=zh_cn&size=1&scl=1&style=6",
                        subDomains: ["1", "2", "3", "4"],
                    }),
                    new WebTileLayer({
                        urlTemplate: "http://wprd0{subDomain}.is.autonavi.com/appmaptile?x={col}&y={row}&z={level}&lang=zh_cn&size=1&scl=1&style=8",
                        subDomains: ["1", "2", "3", "4"],
                    })
                ],
                spatialReference: spatialReference,
